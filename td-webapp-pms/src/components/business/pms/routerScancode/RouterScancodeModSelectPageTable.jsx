...
const RouterScancodeModSelectPageTable = (props) => {
      ...
      { title: bizMap.modName, dataIndex: 'modName', width: 150 },
      {
        title: bizMap.txnChannel, dataIndex: 'txnChannel', render(text) {
          ...
          switch (text) {
            ...
            case '1014': txt = bizMap['txnChannel-1014']; break;
            case '1015': txt = bizMap['txnChannel-1015']; break;
            case '1016': txt = bizMap['txnChannel-1016']; break;
            default: break;
          }
...
RouterScancodeModSelectPageTable.propTypes = {
...
RouterScancodeModSelectPageTable.defaultProps = {
...
export default RouterScancodeModSelectPageTable;
