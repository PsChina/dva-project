...
const RouterModMerScancodeQueryForm = (props) => {
...
RouterModMerScancodeQueryForm.propTypes = {
  formSubmit: PropTypes.func,
  addClick: PropTypes.func,
};

RouterModMerScancodeQueryForm.defaultProps = {
  formSubmit: noop,
  addClick: noop,
}

export default Form.create()(RouterModMerScancodeQueryForm);
