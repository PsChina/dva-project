...
export function setSession(key, val) {
  sessionStorage.removeItem(key); // eslint-disable-line
  sessionStorage.setItem(key, val.toString()); // eslint-disable-line
}
...
export function getSession(key) {
  return sessionStorage.getItem(key); // eslint-disable-line
}
...
export function setLocal(key, val) {
  localStorage.removeItem(key); // eslint-disable-line
  localStorage.setItem(key, val.toString()); // eslint-disable-line
}
...
export function getLocal(key) {
  return localStorage.getItem(key); // eslint-disable-line
}
...
export function setCookie(key, val, days) {
  ...
  const v = escape(val);
  document.cookie = `${key}=${v};expires=${exp.toGMTString()}`; // eslint-disable-line
}
