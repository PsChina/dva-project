...
import { Form, Input, Button, Row, Col, Modal, Cascader, Select } from 'antd';
...
import { postValid, phoneValid, userRealNameValidate, braNameValid } from '../../../../../utils/vaild';
          ...
          <FormItem label={bizMap.braName} {...formItemLayout1} hasFeedback>
            {
              getFieldDecorator('braName', {
                ...
                rules: [{ required: true, message: vaildMap.vaildBraName }, { validator: braNameValid }],
              })(
