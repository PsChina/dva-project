  ...
  return (
    <Spin spinning={loading}>
      <Form layout="horizontal" onSubmit={handleSubmit}>
        ...
        <Row>
          <Col span={24}>
            <FormItem label={bizMap.agtParentId} {...formItemLayout} hasFeedback>
              {
                getFieldDecorator('agtParentId', {
                  initialValue: data.agtParentId,
                  rules: [{ required: true }],
                })(
                  <Input placeholder={bizMap.agtParentId} disabled />,
                )
              }
            </FormItem>
          </Col>
