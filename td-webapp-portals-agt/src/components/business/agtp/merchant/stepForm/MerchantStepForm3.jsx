  ...
  const handleSubmit = (ev) => {
    ...
    validateFieldsAndScroll((errors) => {
      if (errors) {
        ...
        let isPicUpload = false;
        let picUploadStr = "";
        if (typeof dat.FJID_PIC_01 === 'undefined' || dat.FJID_PIC_01 === '') {
          picUploadStr += testFiles[0].label + '、';
          isPicUpload = true;
        }
        if (typeof dat.FJID_PIC_02 === 'undefined' || dat.FJID_PIC_02 === '') {
          picUploadStr += testFiles[1].label + '、';
          isPicUpload = true;
        }
        // 手持身份证照 选填
        /*if (typeof dat.FJID_PIC_03 === 'undefined' || dat.FJID_PIC_03 === '') {
          picUploadStr += testFiles[2].label + '、';
          isPicUpload = true;
        }*/
        if (typeof dat.FJID_PIC_04 === 'undefined' || dat.FJID_PIC_04 === '') {
          picUploadStr += testFiles[3].label + '、';
          isPicUpload = true;
        }
        /*if (typeof dat.FJID_PIC_05 === 'undefined' || dat.FJID_PIC_05 === '') {
          picUploadStr += testFiles[4].label + '、';
          isPicUpload = true;
        }*/
        if (typeof dat.FJID_PIC_06 === 'undefined' || dat.FJID_PIC_06 === '') {
          picUploadStr += testFiles[5].label + '、';
          isPicUpload = true;
        }
        if (typeof dat.FJID_PIC_07 === 'undefined' || dat.FJID_PIC_07 === '') {
          picUploadStr += testFiles[6].label + '、';
          isPicUpload = true;
        }
        if (typeof dat.FJID_PIC_08 === 'undefined' || dat.FJID_PIC_08 === '') {
          picUploadStr += testFiles[7].label + '、';
          isPicUpload = true;
        }
        if (typeof dat.FJID_PIC_09 === 'undefined' || dat.FJID_PIC_09 === '') {
          picUploadStr += testFiles[8].label + '、';
          isPicUpload = true;
        }
        if ((typeof dat.FJID_PIC_10 === 'undefined' || dat.FJID_PIC_10 === '') &&
          (typeof dat.FJID_PIC_11 === 'undefined' || dat.FJID_PIC_11 === '') &&
          (typeof dat.FJID_PIC_12 === 'undefined' || dat.FJID_PIC_12 === '')) {
          isPicUpload = true;
          let isHaveNull = false;
          if (typeof dat.FJID_PIC_10 === 'undefined' || dat.FJID_PIC_10 === '') {
            isHaveNull = true;
            picUploadStr += testFiles[9].label + '、';
          } else if (!isHaveNull || typeof dat.FJID_PIC_11 === 'undefined' || dat.FJID_PIC_11 === '') {
            isHaveNull = true;
            picUploadStr += testFiles[10].label + '、';
          } else if (!isHaveNull || typeof dat.FJID_PIC_12 === 'undefined' || dat.FJID_PIC_12 === '') {
            picUploadStr += testFiles[11].label + '、';
          }
        }
        if (typeof dat.FJID_PIC_LOGO === 'undefined' || dat.FJID_PIC_LOGO === '') {
          picUploadStr += testFiles[12].label + '、';
          isPicUpload = true;
        }
        if (isPicUpload) {
          picUploadStr = picUploadStr.substring(0, picUploadStr.length - 1);
          callModalPage(commonMap.fail, picUploadStr + ' ' + commonMap.picUpload, 'error', commonMap.okText);
          return;
        }
        dat.attachmentIds = [dat.FJID_PIC_01, dat.FJID_PIC_02, dat.FJID_PIC_03, dat.FJID_PIC_04,
          dat.FJID_PIC_05, dat.FJID_PIC_06, dat.FJID_PIC_07, dat.FJID_PIC_08, dat.FJID_PIC_09, dat.FJID_PIC_10, dat.FJID_PIC_11, dat.FJID_PIC_12, dat.FJID_PIC_LOGO].toString();
        nextClick(dat);
      }
      //resetFields();
    });
