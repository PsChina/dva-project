...
const MerchantAttachDetailInfoForm = (props) => {
  ...
  for (let idx = 0; idx < 13; idx++) {
    if (idx === '12') {
      i = 'FJSRC_PIC_LOGO';
      nPic = 'FJNAME_PIC_LOGO';
    } else {
      i = `FJSRC_PIC_0${idx + 1}`;
      nPic = `FJNAME_PIC_0${idx + 1}`;
    }
    ...
    if (data[i] !== undefined && data[i].substring(0, 5) === prefix) {
      ...
      if (pos > 0) {
        ...
        //const temp = Config.agtpFileHost + srcPic + '?tk=' + tk + '&typ=' + suffix;
        const temp = `${agtpFileHost + srcPic}?tk=${tk}&typ=${suffix}`;
        switch (idx + 1) {
  ...
  const testFiles = [
    ...
    },
    {
      ...
      name: 'j.png',
      editable: false,
      url: imgPic10 !== '' ? imgPic10 : image + data.FJSRC_PIC_10,
    ...
    },
    {
      ...
      name: 'j.png',
      editable: false,
      url: imgPic11 !== '' ? imgPic11 : image + data.FJSRC_PIC_11,
    ...
    },
    {
      ...
      name: 'j.png',
      editable: false,
      url: imgPic12 !== '' ? imgPic12 : image + data.FJSRC_PIC_12,
    ...
    },
    {
      ...
      name: 'j.png',
      editable: false,
      url: imgPic13 !== '' ? imgPic13 : image + data.FJSRC_PIC_LOGO,
