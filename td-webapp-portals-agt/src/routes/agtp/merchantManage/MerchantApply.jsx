...
import MerchantStepForm1 from '../../../components/business/agtp/merchant/stepForm/MerchantStepForm1';
import MerchantStepForm2 from '../../../components/business/agtp/merchant/stepForm/MerchantStepForm2';
import MerchantStepForm3 from '../../../components/business/agtp/merchant/stepForm/MerchantStepForm3';
...
const MerchantApply = ({ dispatch, merchantApply }) => {
  ...
  const { currentStep, submiting, form1Data, form2Data, form3Data, agentData,
     subBankList, agentModalVisible, subBankModalVisible, bankList, bizSaleList, industryList } = merchantApply;
