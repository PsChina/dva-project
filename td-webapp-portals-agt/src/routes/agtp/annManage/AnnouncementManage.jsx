...
import AnnouncementQueryForm from '../../../components/business/agtp/announcement/AnnouncementQueryForm';
import AnnouncementPageTable from '../../../components/business/agtp/announcement/AnnouncementPageTable';
import AnnouncementTable from '../../../components/business/agtp/announcement/AnnouncementTable';
import * as i18n from '../../../utils/i18n';

const AnnouncementManage = ({ dispatch, announcementManage }) => {
  const objectid = 'annId';
  const bizMap = i18n.bizMap('agtp/announcement');
