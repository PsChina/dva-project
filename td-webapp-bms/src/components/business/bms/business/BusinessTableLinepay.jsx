...
const BusinessTableLinepay = (props) => {
          ...
          data.merMod === '1' ?
            <table key="info" className="detail_table" style={{ width: '100%' }}>
              <tbody>
                ...
                <tr>
                  <td className="detail_table_label">{bizMap.linepayChannelId}</td>
                  <td colSpan={3}>{data.linepayChannelId}</td>
                </tr>
                <tr>
                  <td className="detail_table_label">{bizMap.linepaySecretKey}</td>
                  <td colSpan={3}>{data.linepaySecretKey}</td>
                </tr>
              </tbody>
            </table> : [
              <table key="info" className="detail_table" style={{ width: '100%' }}>
...
BusinessTableLinepay.propTypes = {
  loading: PropTypes.bool,
  data: PropTypes.object,
};

BusinessTableLinepay.defaultProps = {
  loading: false,
  data: {},
}

export default BusinessTableLinepay;
