import * as service from '../../services/rms/storeLimit';
...
// 基础配置信息
const namespace = 'storeLimitManage';
const objectId = 'braId';
const enterPath = '/rms/limitManage/storeLimitManage';
// 基础公共信息
  ...
  effects: {
    ...
    * addOne({ payload }, { call, put, select }) {
      ...
      if (detail.rspCod === '200') {
       ...
       // detail.riskBraIdIsExist?callNotice(commonMap.fail, detail.rspMsg || commonMap.isExiste , 'error'):
        //callNotice(commonMap.fail, detail.rspMsg || commonMap.failInfo, 'error');
