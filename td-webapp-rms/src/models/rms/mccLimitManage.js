import * as service from '../../services/rms/mccLimit';
import * as miniFormService from '../../services/rms/mcc';
import { parseResponse } from '../../utils/request';
import { callNotice } from '../../utils/alert';
import * as i18n from '../../utils/i18n';

// 基础配置信息
const namespace = 'mccLimitManage';
const objectId = 'mccNo';
const enterPath = '/rms/limitManage/mccLimitManage';
// 基础公共信息
    ...
    setup({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === enterPath) {
          ...
          dispatch({ type: 'queryMccList', payload: { miniFormTableParam: { currentPage: 1 } } });
        }
      });
    },
  },
  effects: {
    ...
    * addOne({ payload }, { call, put, select }) {
      ...
      if (detail.rspCod === '200') {
        ...
        //detail.riskMccNoIsExist?callNotice(commonMap.fail, detail.rspMsg || commonMap.isExiste , 'error'):
       // callNotice(commonMap.fail, detail.rspMsg || commonMap.failInfo, 'error');
