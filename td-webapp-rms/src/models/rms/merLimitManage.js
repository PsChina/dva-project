import * as service from '../../services/rms/merLimit';
...
// 基础配置信息
const namespace = 'merLimitManage';
const objectId = 'merId';
const enterPath = '/rms/limitManage/merLimitManage';
// 基础公共信息
  ...
  effects: {
    ...
    * addOne({ payload }, { call, put, select }) {
      ...
      if (detail.rspCod === '200') {
        ...
        //detail.riskMerIdIsExist?callNotice(commonMap.fail, detail.rspMsg || commonMap.isExiste , 'error'):
        //callNotice(commonMap.fail, detail.rspMsg || commonMap.failInfo, 'error');
