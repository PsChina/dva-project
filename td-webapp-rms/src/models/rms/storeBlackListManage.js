import * as service from '../../services/rms/storeBlackList';
import * as miniFormService from '../../services/rms/store';
import { parseResponse } from '../../utils/request';
import { callNotice } from '../../utils/alert';
import * as i18n from '../../utils/i18n';

// 基础配置信息
const namespace = 'storeBlackListManage';
const objectId = 'braId';
const enterPath = '/rms/blackListManage/storeBlackListManage';
// 基础公共信息
    ...
    setup({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === enterPath) {
          ...
          dispatch({ type: 'queryStoreList', payload: { miniFormTableParam: { currentPage: 1 } } });
        }
      });
    },
  },
