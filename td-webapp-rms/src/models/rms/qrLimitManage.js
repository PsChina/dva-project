import * as service from '../../services/rms/qrLimit';
import * as miniFormService from '../../services/rms/qr';
import { parseResponse } from '../../utils/request';
import { callNotice } from '../../utils/alert';
import * as i18n from '../../utils/i18n';

// 基础配置信息
const namespace = 'qrLimitManage';
const objectId = 'qrId';
const enterPath = '/rms/limitManage/qrLimitManage';
// 基础公共信息
    ...
    setup({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === enterPath) {
          ...
          dispatch({ type: 'queryQrList', payload: { miniFormTableParam: { currentPage: 1 } } });
        }
      });
    },
  },
  effects: {
    ...
    * addOne({ payload }, { call, put, select }) {
      ...
      if (detail.rspCod === '200') {
        ...
        //detail.riskQrIdIsExist?callNotice(commonMap.fail, detail.rspMsg || commonMap.isExiste , 'error'):
        //callNotice(commonMap.fail, detail.rspMsg || commonMap.failInfo, 'error');
